<?php
    ...
    foreach ($koikoi->zones as $zoneID => $zone) {
        if ($zoneID == 0) {
            echo "Player 1's Hand: <br />";
        }
        if ($zoneID == 1) {
            echo "Player 1's Prizes: <br />";
        }
        if ($zoneID == 2) {
            echo 'Table: <br />';
        }
        if ($zoneID == 3) {
            echo "Player 2's Hand: <br />";
        }
        if ($zoneID == 4) {
            echo "Player 2's Prizes: <br />";
        }

        if (count($zone) < 1) {
            echo 'None';
        } elseif ($zoneID == 0 || $zoneID == 2 || $zoneID == 3) {
            $i = 0;
            foreach ($zone as $card) {
                ...
                if ($i == count($zone)) {
                    echo '<br /><br />';
                } elseif ($zoneID == 2 && $i % round(count($zone) / 2) == 0) {
                    echo '<br />';
                }
            }
        } else {
