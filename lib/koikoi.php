    ...
    class koikoi extends Hanafuda
    {
        ...
        */
        ...
        private function _first_deal()
        {
            ...
            usort($this->zones[0], [$this, '_deck_sort_by_earliest_month']);
            usort($this->zones[2], [$this, '_deck_sort_by_earliest_month']);
            usort($this->zones[3], [$this, '_deck_sort_by_earliest_month']);
        }
        ...
        */
        ...
        private function _shuffle()
        {
            ...
            while (count($cards) > 0) {
                ...
                $this->deck[] = $cards[$i];
                unset($cards[$i]);
                usort($cards, [$this, '_deck_sort_by_id']);
            }
        }
